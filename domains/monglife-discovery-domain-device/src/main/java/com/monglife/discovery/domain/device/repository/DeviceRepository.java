...
public interface DeviceRepository extends JpaRepository<DeviceEntity, Long>, DeviceCustomRepository {
    ...
    List<DeviceEntity> findByDeviceIdIn(Collection<String> deviceIds);
}
